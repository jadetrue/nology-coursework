...
describe("getEmployedPeople() tests", () => {
    ...
    it("Should return an array of employed people objects", async () => {
        const employedPeopleArr = await getEmployedPeople(
            "./mockPersonApi.json"
        );
...
describe("findPersonWithId() tests", () => {
    ...
    it("Should return a person with the id of 001", async () => {
        const personId001 = await findPersonWithId(
            "./mockPersonApi.json",
            "001"
        );
    ...
    it("Should return a person with the id of 005", async () => {
        const personId005 = await findPersonWithId(
            "./mockPersonApi.json",
            "005"
        );
...
xdescribe("setDescription() tests", () => {
    ...
    it("Should add accurate description to each object", async () => {
        const peopleWthDescriptions = await setDescriptions(
            "./mockPersonApi.json"
        );
...
xdescribe("setInterestDetails() tests", () => {
    ...
    it("Should turn the interests key into an array of objects", async () => {
        ...
        expect(Array.isArray(detailedInterestsResponse[0].interests)).toBe(
            true
        );
