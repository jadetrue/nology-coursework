...
describe("Testing sortCharactersAlphabetically()", () => {
    ...
    it("Should return an Array", () => {
        ...
        expect(
            Array.isArray(sortCharactersAlphabetically(["Test"]))
        ).toBeTruthy();
    });
    ...
    it("Should sort lowercase letters alphabetically", () => {
        ...
        expect(sortCharactersAlphabetically(sortedCharArr)).toEqual(
            sortedCharArr
        );
...
describe("Testing checkItemInstock()", () => {
    ...
    it("Should handle single items from the stock list", () => {
        expect(checkItemInstock("apple")).toBe(
            expectedMatchMessage("apple", 0)
        );
        expect(checkItemInstock("melon")).toBe(
            expectedMatchMessage("melon", 10)
        );
    });

    it("Should handle single no match items", () => {
        expect(checkItemInstock("carrot")).toBe(
            expectedNoMatchMessage("carrot")
        );
